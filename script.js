(() => {
    ...
    const n = (t) => {
        ...
        query = n.value, query ? c(e.filter(( (e) => {
    ...
    const i = (t) => {
     ...
     const c = (e) => {
        ...
        for (const c of e) {
            ...
            a.innerText = c.title; const u = document.createElement("p");
            u.innerText = "Penulis: " + c.author; const r = document.createElement("p");
            if (r.innerText = "Tahun: " + c.year,
                e.appendChild(a), e.appendChild(u),
                e.appendChild(r), c.isComplete) {
                ...
                d.id = c.id, d.innerText = "Selesai dibaca",
                    d.classList.add("green"), d.addEventListener("click", o);
                const a = document.createElement("button");
                a.id = c.id, a.innerText = "Hapus buku", a.classList.add("red"),
                    a.addEventListener("click", i), n.appendChild(d),
                    n.appendChild(a), e.appendChild(n), t.appendChild(e)
            }
        }
    }
    function a() {
